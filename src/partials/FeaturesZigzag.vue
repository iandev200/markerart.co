<template>
  <section>
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20 border-t border-gray-800">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-16">
          ...
          <h1 class="h2 mb-4">We would love to help you</h1>
          ...
          <div class="md:grid md:grid-cols-12 md:gap-6 items-center">
            ...
            >
              <div class="md:pr-4 lg:pr-12 xl:pr-16">
                ...
                <h3 class="h3 mb-3">pinpoint your passions</h3>
          ...
          <div class="md:grid md:grid-cols-12 md:gap-6 items-center">
            ...
            >
              <div class="md:pl-4 lg:pl-12 xl:pl-16">
                ...
                <h3 class="h3 mb-3">capitalise on your opportunities</h3>
                <!-- <p class="text-xl text-gray-400 mb-4">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                </p> -->
          ...
          <div class="md:grid md:grid-cols-12 md:gap-6 items-center">
            ...
            >
              <div class="md:pr-4 lg:pr-12 xl:pr-16">
                ...
                <h3 class="h3 mb-3">derive purpose from your creativity</h3>
                <!-- <p class="text-xl text-gray-400 mb-4">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                </p> -->
    ...
    <div class="max-w-3xl mx-auto my-20 text-center md:pb-20"></div>
    <div class="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
      <div data-aos="fade-up" data-aos-delay="400">
        <a
          class="btn text-white bg-purple-600 mt-20 hover:bg-purple-700 w-full mb-4 sm:w-auto sm:mb-0"
          href="/questionnaire"
          target="blank"
          >Make Your Mark</a
        >
