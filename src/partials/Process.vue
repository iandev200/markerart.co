      ...
      <div class="pt-10 pb-12 md:pt-16 md:pb-20">
        ...
        <div class="max-w-3xl mx-auto my-40 text-center md:pb-20">
          <h2 class="h2 mb-4" data-aos="fade-up" data-aos-delay="400">
            Feel like your artistic intuition is less of an occasional hobby and
            more of a meaningful responsibility?
          </h2>
          <!-- <p
        ...
        >
          ...
          >
            ...
            <!-- <p class="text-lg text-gray-400 text-center">
              We are harnessing our intuition while simultaneously building
